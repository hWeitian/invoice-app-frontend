          ...
          <div id="io">
            <div style={{ maxWidth: "210mm", padding: "8mm" }}>
              <div style={{ display: "flex", flexWrap: "wrap", width: "100%" }}>
                ...
                <div style={{ width: "100%" }}>
                  <p style={{ fontSize: "10px" }}>
                    We agree to pay for any production cost incurred in addition
                    to the charges listed. <br />
                    We agree to be bound by the terms and conditions specified
                    on the advertiser agreement.
                  </p>
                </div>
